...
inline _LIBCPP_HIDE_FROM_ABI constexpr void __swap_bitmap_pos(
...
template <class _AlgPolicy,
          ...
          class _RandomAccessIterator,
          class _ValueType = typename iterator_traits<_RandomAccessIterator>::value_type>
inline _LIBCPP_HIDE_FROM_ABI constexpr void __bitset_partition_partial_blocks(
...
template <class _AlgPolicy, class _RandomAccessIterator>
inline _LIBCPP_HIDE_FROM_ABI constexpr void __swap_bitmap_pos_within(
...
_LIBCPP_HIDE_FROM_ABI constexpr std::pair<_RandomAccessIterator, bool>
...
constexpr void __introsort(_RandomAccessIterator __first,
